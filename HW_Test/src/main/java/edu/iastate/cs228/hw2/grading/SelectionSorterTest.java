...
import edu.iastate.cs228.hw2.grading.student_extensions.StudentSelectionSorter;

@Total(value=12)
public class SelectionSorterTest {

	edu.iastate.cs228.hw2.solution.AbstractSorter solutionSorter;
	StudentSelectionSorter studentSorter;
	...
	public void testSortXCoordinate() {
		...
		studentSorter = new StudentSelectionSorter(studentPoints);
