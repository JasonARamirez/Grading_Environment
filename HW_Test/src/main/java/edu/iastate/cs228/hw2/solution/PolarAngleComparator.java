...
/**
 * 
 * This class compares two points p1 and p2 by polar angle with respect to a reference point. It is known that the reference point is not above either
 * p1 or p2, and in the case that either or both of p1 and p2 have the same y-coordinate, not to their right.
 *
 */
public class PolarAngleComparator implements Comparator<Point> {
	...
	/**
	 * Use cross product and dot product to implement this method. Do not take square roots or use trigonometric functions. See the PowerPoint notes
	 * on how to carry out cross and dot products. Calls private methods crossProduct() and dotProduct().
	 * 
	 ...
	 *            c) neither p1 nor p2 equals referencePoint, p1 and p2 have the same polar angle w.r.t. referencePoint, and p1 is closer to 
	...
	public int compare(Point p1, Point p2) {
		return comparePolarAngle(p1, p2) == 0 ? compareDistance(p1, p2) : comparePolarAngle(p1, p2);
	}

	/**
	 * Compare the polar angles of two points p1 and p2 with respect to referencePoint. Use cross products. Do not use trigonometric functions.
	 * 
	...
	/**
	 * Compare the distances of two points p1 and p2 to referencePoint. Use dot products. Do not take square roots.
	 * 
	 * Ought to be private but made public for testing purpose.
	 * 
	 * @param p1
	...
	public int compareDistance(Point p1, Point p2) {
		return Integer.compare(dotProduct(p1, p1), dotProduct(p2, p2));
	}
	...
	private int crossProduct(Point p1, Point p2) {
		int x1 = referencePoint.getX() - p1.getX(), y1 = referencePoint.getY() - p1.getY();
		int x2 = referencePoint.getX() - p2.getX(), y2 = referencePoint.getY() - p2.getY();
		return x1 * y2 - x2 * y1;
	}
