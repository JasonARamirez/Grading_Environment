...
public class Plot {
	...
	private static class MyPanel extends JPanel {
		...
		/**
		 * This method draws the x- and y-axes with the origin at the pixel position (ox, oy). You are suggested not to modify the method unless you understand what is going on.
		 * 
		 * @param g2
		 */
		...
		/**
		 * Draw a line segment connecting (x1, y1) and (x2, y2). Both points are represented by the center pixels of their squares.
		 * 
		...
		/**
		 * x- or y-coordinate of the center pixel in the square representing a point with Cartesian x-coordinate or y-coordinate i.
		 * 
		 * @param i
		 * @return
		 */
		...
		/**
		 * minimum x- or y-coordinate of any pixel in the square representing a point with Cartesian x- or y-coordinate i.
		 * 
		 * @param i
		 * @return
		 */
